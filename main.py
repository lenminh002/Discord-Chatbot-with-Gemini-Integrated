...
async def chat_with_gemini(prompt):
    ...
    if(len(ai_text) > 2000):
        redo_prompt = "The previous response exceeded the character limit. Please provide a concise summary of the previous answer."
        return chat_with_gemini(redo_prompt)
